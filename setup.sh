...
echo ""
echo "  3. Copy ~/.ssh/config and ~/.aws/config from Notion"
echo ""
echo "  4. Sign in to 1Password:"
echo "       eval \$(op signin)"
echo ""
echo "  5. Allow direnv (loads Nix env + secrets):"
echo "       direnv allow ~"
echo ""
echo "  6. Open a new shell — setup complete."
